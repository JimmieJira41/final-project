<template>
  <div class="container">
    <div>
      <h2 class="mb-4">แก้ไขรายการสั่งซื้อ</h2>
    </div>
            ...
            <div class="row">
              <div class="col-6 px-1">
                <button
                  ...
                  "
                  class="btn btn-warning mx-auto h-100 w-100"
                  type="button"
              ...
              <div class="col-6 px-1">
                <button
                  :disabled="
                    customerSelected == undefined || customerSelected == null
                  "
                  class="btn btn-primary mx-auto h-100 w-100"
                  type="button"
                  data-bs-toggle="modal"
...
export default {
  ...
  methods: {
    ...
    getOrder(id_order) {
      axios
        .get("/api/order/get-order/" + id_order, this.headers)
        .then((response) => {
          if (response) {
    ...
    getCustomer(keyword_search_customer) {
      axios
        .get(
          "/api/customer/get-customer/" + keyword_search_customer,
          this.headers
        )
        .then((response) => {
          if (response) {
    ...
    submitUpdateOrder() {
      ...
      if (orderNotReady) {
        ...
        this.$swal({
          title: "แจ้งเตือน",
          text: "คุณต้องการแก้ไขรายการสั่งซื้อ ใช่หรือไม่ ?",
          icon: "warning",
          showCancelButton: true,
          confirmButtonText: "ยืนยัน",
          cancelButtonText: "ยกเลิก",
