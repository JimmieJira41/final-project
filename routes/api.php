...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::prefix('admin')->group(function () {
        Route::get('/logout', [AdminManagement::class, 'logout']);
    ...
    Route::prefix('order')->group(function () {
        ...
        Route::get('/view-slip/{keyword}', [OrderManagement::class, 'viewSlip']);
        Route::post('/validate-slip', [OrderManagement::class, 'validateSlip']);
        Route::post('/upload-slip', [OrderManagement::class, 'uploadSlip']);
        ...
        Route::get('/cut-off-order', [OrderManagement::class, 'cutOffOrder']);
        ...
        Route::post('/get-check-report-excel-file', [OrderManagement::class, 'CheckReportExportExcel']);
    });
    ...
    Route::prefix('promotion')->group(function () {
        ...
        Route::delete('/delete-promotion/{keyword}', [PromotionManagement::class, 'deletePromotion']);
    ...
    Route::prefix('analysis')->group(function () {
        ...
        Route::get('/get-total-used-stock/{keyword}', [AnalysisManagement::class, 'getTotalUseStock']);
        Route::get('/get-detail-report', [AnalysisManagement::class, 'getDetailReport']);
        Route::get('/get-detail-report-by-id/{keyword}', [AnalysisManagement::class, 'getDetailReportById']);
        Route::post('/create-detail-report', [AnalysisManagement::class, 'createDetailReport']);
        Route::post('/update-detail-report', [AnalysisManagement::class, 'updateDetailReport']);
        Route::delete('/delete-detail-report', [AnalysisManagement::class, 'deleteDetailReport']);
        Route::post('/export-summary-report', [AnalysisManagement::class, 'exportSummaryReport']);
    });
    // });
});
